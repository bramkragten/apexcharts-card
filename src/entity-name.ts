...
import { EntityName } from './types-config';
...
/**
 * `hass.formatEntityName` only accepts a series' `name` option (a user string, a
 ...
 * swap) leaves series names stale until an unrelated update forces a redraw.
 */
